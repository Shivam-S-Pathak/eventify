...
async function send_dec_mail(sendto,name,event_name) {
  try {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
          ...
          <div style="padding: 20px; background-color: #ffffff;">
            ...
            <p style="font-size: 16px; color: #333333; line-height: 1.6;">
              We are sorry to inform that your request towards the ${event_name} event is cancelled
              by the Admin .
            </p>
           ...
           <p style="font-size: 16px; color: #333333; line-height: 1.6;">
              For further any query please reach out our helpdesk or contact
              to sairteventifyhelp@gmail.com
            </p>
